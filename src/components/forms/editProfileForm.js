...
import { getProfile, createProfile } from "../../actions/profiles";
...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      // set states from profile database
      this.setState({ data: {
  ...
  render() {
    const asterisk = <asterisk style={{ color: 'red'}}>*</asterisk>
        ...
        >Go back to dashboard</button>
          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <p className="lead text-center">Update your with your latest info</p>
